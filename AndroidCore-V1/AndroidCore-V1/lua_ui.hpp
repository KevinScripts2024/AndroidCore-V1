...
#include <string>
// Lua UI we are gonna execute ( big thanks to nop )

std::string lua_ui = R"(
print("hello roblox!")
local AndroidCore = Instance.new('ScreenGui')
...
AndroidCore.Name = "AndroidCore"
AndroidCore.Parent = game:WaitForChild("CoreGui")

Main.Name = "Main"
Main.Parent = AndroidCore
